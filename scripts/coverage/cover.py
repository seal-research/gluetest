...
python_path = "commons-cli-python/src/main/python"
...
os.system('mvn -f commons-cli-graal/pom.xml test -Drat.skip > /dev/null 2>&1')

with open('commons-cli-graal/trace.txt') as f:
    lines = f.readlines()
