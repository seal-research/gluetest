...
final class OptionValidator {
     ...
     */
    private static Value clz = ContextInitializer.getPythonClass("option_validator.py", "OptionValidator");
    ...
    private static boolean isValidChar(final char c) {
        return clz.invokeMember("is_valid_char", c).asBoolean();
    }
    ...
    private static boolean isValidOpt(final char c) {
        return clz.invokeMember("is_valid_opt", c).asBoolean();
    }
    ...
    static String validate(final String option) throws IllegalArgumentException {
        try {            
            return clz.invokeMember("validate", option).asString();
