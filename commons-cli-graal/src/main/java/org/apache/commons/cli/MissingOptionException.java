...
public class MissingOptionException extends ParseException {
     ...
     */
    private static Value clz = ContextInitializer.getPythonClass("missing_option_exception.py",
    ...
    private static String createMessage(final List<?> missingOptions) {
        return clz.invokeMember("_create_message", missingOptions).asString();
    }
    ...
    public MissingOptionException(final List missingOptions) {
        ...
        obj = clz.execute(missingOptions);
    }
    ...
    public List getMissingOptions() {
        return obj.invokeMember("get_missing_options").as(List.class);
    }
}
